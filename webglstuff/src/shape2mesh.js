...
/*
    Modified from https://github.com/schteppe/cannon.js/blob/master/src/demo/Demo.js
*/

import CANNON from 'cannon';

export default function shape2mesh(body){
    var obj = new THREE.Object3D();

    var currentMaterial = new THREE.MeshBasicMaterial({wireframe: true});
